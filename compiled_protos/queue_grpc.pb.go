...
func (c *queueServiceClient) Enqueue(ctx context.Context, in *DataEntryArray, opts ...grpc.CallOption) (*EnqueueResponse, error) {
...
func (c *queueServiceClient) Dequeue(ctx context.Context, in *DequeueRequest, opts ...grpc.CallOption) (*DataEntryArray, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DataEntryArray)
...
func (UnimplementedQueueServiceServer) Enqueue(context.Context, *DataEntryArray) (*EnqueueResponse, error) {
...
func _QueueService_Enqueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueueServiceServer).Enqueue(ctx, req.(*DataEntryArray))
	}
